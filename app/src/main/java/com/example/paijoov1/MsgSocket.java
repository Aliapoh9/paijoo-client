...
public class MsgSocket implements Serializable {
    ...
    public static class Messages implements Serializable {
        ...
        public Messages(Integer id, Integer author_id, Integer recipient_id, Integer content_type, TextContent content, Boolean seen, Boolean received, Calendar created_at, Integer conversation_id) {
            this.id = id;
